...
export default class Admin extends Component {
    ...
    render() {
            return ( <
                ...
                <
                div className = {
                    this.state.condition ? "quoteBG active" : "quoteBG"
                } >
                <
                div className = {
                    this.state.condition ? "quote active" : "quote"
                } >
                <
                ...
                <
                label >
                Nombre: < input required type = "text"
                value = {
                ...
                /label> <
                label >
                Descripci & oacute; n: < input required type = "text"
                value = {
                ...
                /label> <
                label >
                Url Imagen: < input required type = "text"
                value = {
                    this.state.item.urlImagen
                }
                onChange = {
                    this.urlChange
                }
                ...
                <
                label >
                Alto(m): < input required type = "number"
                value = {
                    this.state.item.alto
                }
                onChange = {
                    this.highChange
                }
                ...
                /label> <
                label >
                Ancho(m): < input required type = "number"
                value = {
                    this.state.item.ancho
                }
                onChange = {
                    this.weightChange
                }
                ...
                /label> <
                label >
                Largo(m): < input required type = "number"
                value = {
                    this.state.item.largo
                }
                onChange = {
                    this.longChange
                }
                ...
                className = {
                    this.state.condition ? "addBtn active" : "addBtn"
                } > < /button>
